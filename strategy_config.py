...
ENTRY_SIGNAL_THRESHOLD = 10.0
ENTRY_SIGNAL_THRESHOLD_MID_QUALITY = 9.0
ENTRY_SIGNAL_THRESHOLD_HIGH_QUALITY = 8.0
ENTRY_SCORE_FULL = 72.0
ENTRY_SCORE_SCALE = 60.0
ENTRY_SCORE_PROBE = 48.0
ENTRY_PROBE_ALLOC_MULT = 0.40
ENTRY_HARD_REJECT_FUND_FLOOR_RATIO = 0.50
